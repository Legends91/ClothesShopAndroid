...
import com.example.detai.adapter.SpAokieu_Adapter;
import com.example.detai.adapter.SpSetdonam_Adapter;
...
public class phanloai7_setdonam extends AppCompatActivity {
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    APIWeb apiWeb;
    RecyclerView recyclerspdm;
    List<SanPhamMoi> mangSP;
    SpSetdonam_Adapter spSetdonam_adapter;
    Toolbar toolbar;
    int page = 1;
    int loai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanloai7_setdonam);
        toolbar = findViewById(R.id.toolbarSetnam);
        ...
        loai = getIntent().getIntExtra("loai",1007);
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                spSetdonam_adapter = new SpSetdonam_Adapter(getApplicationContext(), mangSP);
                                recyclerspdm.setAdapter(spSetdonam_adapter);
                            }
                        },
                        throwable -> {
