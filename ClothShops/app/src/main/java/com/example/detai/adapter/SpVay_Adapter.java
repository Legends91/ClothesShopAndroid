...
public class SpVay_Adapter extends RecyclerView.Adapter<SpVay_Adapter.MyViewHolder> {
    Context context;
    List<SanPhamMoi> array;

    public SpVay_Adapter(Context context, List<SanPhamMoi> array) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SpVay_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        if(holder instanceof SpVay_Adapter.MyViewHolder){
            SpVay_Adapter.MyViewHolder myViewHolder = (SpVay_Adapter.MyViewHolder) holder;
