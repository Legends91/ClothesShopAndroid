...
public class SpAothun_Adapter extends RecyclerView.Adapter<SpAothun_Adapter.MyViewHolder> {
    Context context;
    List<SanPhamMoi> array;

    public SpAothun_Adapter(Context context, List array) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SpAothun_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        SpAothun_Adapter.MyViewHolder myViewHolder = (SpAothun_Adapter.MyViewHolder) holder;
