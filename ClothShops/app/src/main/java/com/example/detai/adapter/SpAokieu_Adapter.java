...
public class SpAokieu_Adapter extends RecyclerView.Adapter<SpAokieu_Adapter.MyViewHolder> {
    Context context;
    List<SanPhamMoi> array;

    public SpAokieu_Adapter(Context context, List<SanPhamMoi> array) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SpAokieu_Adapter.MyViewHolder(view);
    }
    //Gọi sản phẩm từ database qua ViewHolder
    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        SpAokieu_Adapter.MyViewHolder myViewHolder = (SpAokieu_Adapter.MyViewHolder) holder;
