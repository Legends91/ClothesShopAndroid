...
import com.example.detai.adapter.SpChanVay_Adapter;
...
public class phanloai6_chanvay extends AppCompatActivity {
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    APIWeb apiWeb;
    RecyclerView recyclerspdm;
    List<SanPhamMoi> mangSP;
    SpChanVay_Adapter spChanVay_adapter;
    Toolbar toolbar;
    int page = 1;
    int loai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanloai6_chanvay);
        ...
        loai = getIntent().getIntExtra("loai",1006);
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                spChanVay_adapter = new SpChanVay_Adapter(getApplicationContext(), mangSP);
                                recyclerspdm.setAdapter(spChanVay_adapter);
                            }
                        },
                        throwable -> {
