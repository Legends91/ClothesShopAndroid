...
public class phanloai3_aokieu extends AppCompatActivity {
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    APIWeb apiWeb;
    RecyclerView recyclerspdm;
    List<SanPhamMoi> mangSP;
    SpAokieu_Adapter spAokieu_adapter;
    Toolbar toolbar;
    int page = 1;
    int loai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanloai3_aokieu);
        toolbar = findViewById(R.id.toolbarAokieu);
        ...
        loai = getIntent().getIntExtra("loai",1003);
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                spAokieu_adapter = new SpAokieu_Adapter(getApplicationContext(), mangSP);
                                recyclerspdm.setAdapter(spAokieu_adapter);
                            }
                        },
                        throwable -> {
