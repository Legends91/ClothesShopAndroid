...
import com.example.detai.adapter.SpVay_Adapter;
...
public class phanloai5_vay extends AppCompatActivity {
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    APIWeb apiWeb;
    RecyclerView recyclerspdm;
    List<SanPhamMoi> mangSP;
    SpVay_Adapter spVay_adapter;
    Toolbar toolbar;
    int page = 1;
    int loai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanloai5_vay);
        ...
        loai = getIntent().getIntExtra("loai",1005);
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                spVay_adapter = new SpVay_Adapter(getApplicationContext(), mangSP);
                                recyclerspdm.setAdapter(spVay_adapter);
                            }
                        },
                        throwable -> {
