...
public class SpSetdonam_Adapter extends RecyclerView.Adapter<SpSetdonam_Adapter.MyViewHolder>{
    Context context;
    List<SanPhamMoi> array;

    public SpSetdonam_Adapter(Context context, List<SanPhamMoi> array) {
        this.context = context;
        this.array = array;
    }

    @Override
    public SpSetdonam_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sp,parent,false);
        return new SpSetdonam_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SpSetdonam_Adapter.MyViewHolder holder, int position) {
        SpSetdonam_Adapter.MyViewHolder myViewHolder = (SpSetdonam_Adapter.MyViewHolder) holder;
