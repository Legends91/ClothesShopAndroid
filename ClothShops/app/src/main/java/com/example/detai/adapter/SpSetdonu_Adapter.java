...
public class SpSetdonu_Adapter extends RecyclerView.Adapter<SpSetdonu_Adapter.MyViewHolder>{
    Context context;
    List<SanPhamMoi> array;

    public SpSetdonu_Adapter(Context context, List<SanPhamMoi> array) {
        this.context = context;
        this.array = array;
    }

    @Override
    public SpSetdonu_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sp,parent,false);
        return new SpSetdonu_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SpSetdonu_Adapter.MyViewHolder holder, int position) {
        SpSetdonu_Adapter.MyViewHolder myViewHolder = (SpSetdonu_Adapter.MyViewHolder) holder;
