...
import com.example.detai.adapter.SpSetdonu_Adapter;
...
public class phanloai8_setdonu extends AppCompatActivity {
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    APIWeb apiWeb;
    RecyclerView recyclerspdm;
    List<SanPhamMoi> mangSP;
    SpSetdonu_Adapter spSetdonu_adapter;
    Toolbar toolbar;
    int page = 1;
    int loai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanloai8_setdonu);
        toolbar = findViewById(R.id.toolbarSetnu);
        ...
        loai = getIntent().getIntExtra("loai",1008);
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                spSetdonu_adapter = new SpSetdonu_Adapter(getApplicationContext(), mangSP);
                                recyclerspdm.setAdapter(spSetdonu_adapter);
                            }
                        },
                        throwable -> {
