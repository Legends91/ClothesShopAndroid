...
import com.example.detai.adapter.SpQuantay_Adapter;
...
public class phanloai4_quantay extends AppCompatActivity {
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    APIWeb apiWeb;
    RecyclerView recyclerspdm;
    List<SanPhamMoi> mangSP;
    SpQuantay_Adapter spQuantay_adapter;
    Toolbar toolbar;
    int page = 1;
    int loai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanloai4_quan);
        ...
        loai = getIntent().getIntExtra("loai",1004);
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                spQuantay_adapter = new SpQuantay_Adapter(getApplicationContext(), mangSP);
                                recyclerspdm.setAdapter(spQuantay_adapter);
                            }
                        },
                        throwable -> {
